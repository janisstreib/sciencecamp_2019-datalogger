...
U 1 1 5CF02BB4
P 5200 3600
F 0 "J3" H 5280 3592 50  0000 L CNN
F 1 "OLED" H 5280 3501 50  0000 L CNN
F 2 "parts:12832_SSD1306" H 5200 3600 50  0001 C CNN
...
F 2 "Resistor_THT:R_Axial_DIN0309_L9.0mm_D3.2mm_P12.70mm_Horizontal" V 1430 2550 50  0001 C CNN
...
U 1 1 5CF53AE8
P 9150 2450
F 0 "U2" H 9150 2692 50  0000 C CNN
F 1 "AMS1117-3.3" H 9150 2601 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-223-3_TabPin2" H 9150 2650 50  0001 C CNN
F 3 "http://www.advanced-monolithic.com/pdf/ds1117.pdf" H 9250 2200 50  0001 C CNN
	1    9150 2450
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5CF560D2
P 8500 2600
F 0 "C1" H 8615 2646 50  0000 L CNN
F 1 "0.01uF" H 8615 2555 50  0000 L CNN
...
U 1 1 5CF5790E
P 9850 2600
F 0 "C2" H 9965 2646 50  0000 L CNN
F 1 "10uF" H 9965 2555 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 9888 2450 50  0001 C CNN
...
U 1 1 5CF5C78F
P 8150 2450
F 0 "#PWR0112" H 8150 2300 50  0001 C CNN
...
F 1 "0.01uF" H 10465 2555 50  0000 L CNN
...
Text GLabel 10650 2250 1    50   Output ~ 0
SD_3V3
Wire Wire Line
	9450 4650 8750 4650
Wire Wire Line
...
U 3 1 5CFA1D88
P 8250 5900
F 0 "U1" H 8250 6217 50  0000 C CNN
F 1 "74LVC125" H 8250 6126 50  0000 C CNN
F 2 "Package_SO:TSSOP-14_4.4x5mm_P0.65mm" H 8250 5900 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LVC125" H 8250 5900 50  0001 C CNN
	3    8250 5900
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5CFA4679
P 8250 6150
F 0 "#PWR0116" H 8250 5900 50  0001 C CNN
...
F 2 "Resistor_THT:R_Axial_DIN0309_L9.0mm_D3.2mm_P12.70mm_Horizontal" V 4430 2750 50  0001 C CNN
...
F 2 "Resistor_THT:R_Axial_DIN0309_L9.0mm_D3.2mm_P12.70mm_Horizontal" V 4430 2350 50  0001 C CNN
...
F 1 "R" V 7734 4350 50  0000 C CNN
...
U 1 1 5CFE27C1
P 7800 5900
F 0 "R4" V 7593 5900 50  0000 C CNN
F 1 "R" V 7684 5900 50  0000 C CNN
...
U 1 1 5D0338EC
P 7150 3750
F 0 "R7" H 7080 3704 50  0000 R CNN
F 1 "47/70k" H 7080 3795 50  0000 R CNN
...
U 1 1 5D03681F
P 7150 3600
F 0 "#PWR0122" H 7150 3450 50  0001 C CNN
...
U 1 1 5D042EFF
P 8650 3600
F 0 "R9" H 8720 3646 50  0000 L CNN
F 1 "47k/50k" H 8720 3555 50  0000 L CNN
